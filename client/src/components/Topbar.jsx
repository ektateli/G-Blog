    ...
    return (
        <div className='flex justify-between items-center h-16 fixed w-full z-20 bg-white px-5 border-b'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <Link to="/about" className="inline-block bg-violet-500 text-white font-medium py-2 px-4 rounded-full shadow-md transition-transform duration-300 transform hover:scale-105 hover:bg-purple-600">
                    About
                </Link>
